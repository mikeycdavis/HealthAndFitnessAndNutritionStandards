...
| [02a](02a-trend-corpus.md) | *(companion to 02)* | Every place the repository operationalises repeated observation, organised around the three tensions: the cost-asymmetric single-event override, the same measurement at two timescales, and where a trend *increases* urgency. |
